...
<body class="body-about">
    <div class="about-container">
        ...
        <p>
            The game is already playable on <a href="https://bryanlesc.itch.io/bubble-bear">Itch.io</a> (check the Explore section for the link),
            and the website is actively in development to enhance the competitive experience.
            Start running. Set records. Be the fastest bear.</p>
        </p>
